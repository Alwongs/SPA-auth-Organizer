        ...
        <div class="card-body p-1">
            ...
            <table class="table table-hover bg-light">
                ...
                <tbody>
                    ...
                    <tr class="no-content" v-if="tomorrow.length == 0">
                        <td colspan="5" class="text-center text-secondary">
                            <h5>nothing tomorrow..</h5>
                        </td>                        
                    </tr>

                    <tr class="content" v-for="(event, index) in tomorrow" :key="event.id">
                        <th scope="row">{{index + 1}}.</th>
                        <td @click="$router.push({ name: 'event', params: {id: event.id}})" style="cursor:pointer;" class="show-date"><h5 class="title-brown">{{event.title | capitalize }}</h5></td>
                        <td>
                        ...
                        <td>
                            <button @click.prevent="current_event = event" type="button" class="btn btn-primary" data-toggle="modal" data-target="#tomorrowEditModal">
                            ...
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content">
                                    <div class="modal-header bg-secondary">
                                        <h5 class="modal-title text-light" id="tomorrowEditModalLabel">Edit event</h5>
                                    ...
                                    <div class="modal-body">
                                        <form @submit.prevent="updateEvent(current_event)">
                                            <div class="form-group">
                                                <label for="tomorrowEditTitleModal">title</label>
                                                <input v-model="current_event.title" type="text" class="form-control" id="tomorrowEditTitleModal">
                                            </div>
                                            <div class="form-group">
                                                <label for="tomorrowEditDateModal">date</label>
                                                <input v-model="current_event.date"  type="date" min="2021-01-01" max="2100-01-01" class="form-control" id="tomorrowEditDateModal" required>
                                            </div>
                                            <div class="form-group">
                                                <label for="tomorrowEditTypeModal">Type</label>
                                                <select v-model="current_event.type" class="form-control" id="tomorrowEditTypeModal">
